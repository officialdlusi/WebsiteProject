...
$query = "SELECT * FROM `questions` WHERE questions_number = $number AND topic = 'more_than_less_than_year_4'";
...
$query = "SELECT * FROM `choices` WHERE questions_number = $number AND topic = 'more_than_less_than_year_4'";
...
<body>
    <div class="quiz-container">
        ...
        <form method="post" action="more_than_less_than_year_4_process.php">
            <ul class="choices">
                <?php
