...
$query = "SELECT * FROM `quiz` WHERE questions_number = $number AND topic = 'pv'";
...
$query = "SELECT * FROM `choices` WHERE questions_number = $number AND topic = 'pv'";
...
<body>
    <div class="quiz-container">
        ...
        <form method="post" action="pvprocess.php">
            <ul class="choices">
                <?php
