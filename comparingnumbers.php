...
<div class="lessoncontainer">
        ...
        <p>
            ...
            If we were told to compare two, 3 digit numbers, one being 294 and the other 409, the first thing would be to place both numbers onto a place value chart. If you haven't covered the subject, <strong>place value</strong> or need a refresh, head to the subject though this <a href="placevalue.php">link</a>.
        </p>
        ...
        <input type="button" class="quizbutton" onClick="location.href='cnquiz/cn.php'" value="Quiz">
