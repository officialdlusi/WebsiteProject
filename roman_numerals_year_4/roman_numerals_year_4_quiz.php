...
$query = "SELECT * FROM `questions` WHERE questions_number = $number AND topic = 'roman_numerals_year_4'";
...
$query = "SELECT * FROM `choices` WHERE questions_number = $number AND topic = 'roman_numerals_year_4'";
...
<head>
    ...
    <title>Roman Numerals Q: <?php echo $question['questions_number']; ?></title>
</head>
...
<body>
    <div class="quiz-container">
        ...
        <form method="post" action="roman_numerals_year_4_process.php">
            <ul class="choices">
                <?php
